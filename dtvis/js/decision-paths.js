...
function showClassSizes(cells, rows) {
    ...
    var cells = rows.selectAll('td')
        ...
        .data(function (row) {
            ...
            return colnames.map(function (colname, i) {
                            ...
                            let leafInfo = row[row.length - 1];

                        return {

                    column: colname,

                            // pad array to max column number so that

                        // the class info table can go to the last column

                            row: Array.from({...row, length:ncols}),
        ...
        .attr('id', function (d, i) {
                        ...
                        return i === d.row.length ? d.leaf : null
